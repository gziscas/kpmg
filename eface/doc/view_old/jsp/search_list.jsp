...
function save(){
	...
	if(name==null || typeof(name) == "undefined") {
		...
		//document.getElementById("searchForm").action="../outer/searchLike?name="+name.value;
		//document.getElementById("searchForm").action.method='post';
					...
					<c:choose>
						<c:when test="${not empty datas}">
							<c:forEach items="${datas}" var="data" varStatus="vs">
								<li>
									<a href="../outer/searchInfo?name=${data.entName }">
									<div class="list_top">
